...
const Project = () => {
  ...
  return (
    <div id="projects" className="pt-16 pb-16 bg-[#050709] relative" onClick={handleOutsideClick}>
      <SectionHeading>My Projects</SectionHeading>
      <div className="w-[80%] mx-auto mt-20 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 items-center">
        {projectData.map((project: any, index: number) => {
          return (
            ...
            >
              <div className={`image-container ${index === clickedIndex ? 'scale-up' : ''}`}>
                <Image
                  src={project.image}
                  alt="project"
                  width={300}
      ...
      <style jsx>{`
        ...
        .overlay {
          ...
          z-index: 1;
          background-color: rgba(0, 0, 0, 0.5); /* Add a background to make the blur visible */
        }
