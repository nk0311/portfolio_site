...
const Hero = () => {
  ...
  return (
    <div className="w-full pt-[4vh] md:pt-[12vh] h-screen bg-black overflow-hidden relative">
      <div className="flex justify-center flex-col w-4/5 h-full mx-auto">
        <div className="bg-gray-900 rounded-3xl p-8 shadow-lg shadow-gray-600">
          <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-12">
            {/* Text Content */}
            <div>
              ...
              {/* Title with Typing Effect - now with blue gradient and purple cursor */}
              <h1
                data-aos="fade-right"
                data-aos-delay="100"
                className="text-bg text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold md:leading-[2rem] lg:leading-[2.5rem] xl:leading-[3rem]"
              >
      ...
      {/* Add the same blue gradient styling used in the Project component */}
      <style jsx>{`
        .text-blue-gradient {
